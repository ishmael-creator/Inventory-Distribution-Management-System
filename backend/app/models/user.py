...
from sqlalchemy import Boolean, DateTime, Enum, ForeignKey, String, Text, Column
...
class PushSubscription(Base):
    ...
    # The unique URL generated by Google/Apple for this specific browser
    endpoint = Column(String, nullable=False, unique=True)
    
    # The encryption keys required to securely send the message
